...
- Reworked backend cache architecture to fixed-size Search TT + optional Eval cache only; removed board/depth persistence caches and translated TT usage, aligned score semantics to Black-positive/White-negative, and expanded TT/eval/memory diagnostics.
